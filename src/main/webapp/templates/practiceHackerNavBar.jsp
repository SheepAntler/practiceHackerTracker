...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item ${pageContext.request.requestURI eq '/practiceHackerTracker_war/practiceHackerHome.jsp' ? ' active' : ''}">
                <a class="nav-link" href="practiceHackerHome.jsp">Practice Hacker Home</a>
            </li>
